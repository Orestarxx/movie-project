            ...
            <div id={styles.infoHolder}>
                <div>
                        ...
                        <div id={styles.overviewHolder}>
                            ...
                            <div id={styles.genresHolder}>
                                ...
                                <div id={styles.genreHolder}>
                                    {movieByID.genres?.map((genre: IGenres, index: number) => <div key={index}
                            ...
                            <div id={styles.languageHolder}>
                                ...
                                <div id={styles.languagesHolder}>
                                    {movieByID.spoken_languages?.map((lang: ISpoken_languages, index) => <div
                                        key={index}>
                                        {lang.name}
                                    </div>)}
                                </div>
                    ...
                    <div id={styles.videoHolder}>
                        <FavoriteForTVAndMovies movie={movieByID}/>
